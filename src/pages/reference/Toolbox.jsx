...
export default function Toolbox() {
  ...
  const tools = [
    ...
    { icon: "🧑‍🤝‍🧑", to: "/toolbox/query-compare", phase: "Acquire", title: { zh: "搜尋式比較板", en: "Query Compare Board" }, desc: { zh: "匯入多位成員的專案 JSON，並排比較各自的搜尋策略與結果數（純瀏覽器，不上傳）", en: "Import members’ project JSON files and compare search strategies side by side (in-browser, no upload)" } },
    { icon: "⚖️", to: "/toolbox/casp-sr", phase: "Appraise", title: { zh: "CASP-SR (RCT) 評讀清單", en: "CASP-SR (RCT) Checklist" }, desc: { zh: "13 題逐題指導 + 評分標準 + 常見錯誤 + Kappa 判讀", en: "13-question guide with scoring criteria, pitfalls & Kappa interpretation" } },
    { icon: "🔬", to: "/toolbox/casp-sr-obs", phase: "Appraise", title: { zh: "CASP-SR (Obs) 評讀清單", en: "CASP-SR (Obs) Checklist" }, desc: { zh: "10 題 × 5 區塊 + PECOT(S) 框架 + Newcastle-Ottawa / ROBINS-E 工具", en: "10 questions × 5 sections + PECOT(S) framework + Newcastle-Ottawa / ROBINS-E tools" } },
